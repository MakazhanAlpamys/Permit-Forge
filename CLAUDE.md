...
- **Testing:** Vitest 4 (node + jsdom), @testing-library/react, 73 test suites in `test/` (1201 tests, ~72.1% line / ~60.3% branch coverage as of v1.9.0)
