...
- **Testing:** Vitest 4 (node + jsdom), @testing-library/react, 72 test suites in `test/` (1179 tests, ~72.0% line / ~60.1% branch coverage as of v1.8.0)
