...
- [x] **X11 — M6 (clickpath)** `CreateUserDialog` flicker: close dialog first, then clear form, then refresh users. `components/admin/create-user-dialog.tsx:46-62`. **Track B / F.** 🟢 — (pending commit)
