...
- [x] **X12 — M7 (clickpath)** Admin password-change toast: store setTimeout id in a ref and clear on manual close. `app/admin/page.tsx:183-187`. **Track B / F.** 🟢 — (pending commit)
